...
The second phase is called *validation*, and involves every peer in a channel (including the originating peer) checking these proposed updates to make they conform to the *endorsement policy*.
